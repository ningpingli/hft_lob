...
from hft_lob.data_pipeline.loader import SampleCompiler, SourceSet, discover_sources
from hft_lob.data_pipeline.splitter import WalkForwardPlan, build_fold_plan
...
def _metadata(
    ...
    return DatasetPackageMetadata(
        ...
        processing_config_hash=sources.processing_hash,
        fold_plan_hash=fold_plan_hash,
        labels=tuple(config.target.labels),
    )
